...
function Filter() {
  ...
  // to find unique dept
  const uniqDept = [...new Set(dept)];
  


  // to extract unique values from array
  ...
  return (
    <div className="container_filter p-3">
      <div className="m-4 p-4 tabContainer">
        {uniqDept.map((d, i) => (
          <span key={i} onClick={() => handleTab(d)} className="tabs">
            {" "}
